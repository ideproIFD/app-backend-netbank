...
//    public static final Integer PARAM_MODEL_CLASIFICADOR_RECURSO_WS = 5;
    ...
    public static final String PARAM_IP_WS_AXON = "http://10.0.1.130/wsIdeproAxonWs/WSClientAxon/"; // laboratorio
   // public static final String PARAM_IP_WS_AXON = "http://10.0.1.49/wsIdeproAxonWs/WSClientAxon/"; // Produccion
